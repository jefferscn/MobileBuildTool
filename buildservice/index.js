...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(49)('myapp:server');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var pack = function () {
	    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(cfg) {
	        var o, defaultPlugins, logFile, logger, isExist, uploadLogData;
	            ...
	            while (1) {
	                switch (_context2.prev = _context2.next) {
	                    case 0:
	                        ...
	                        defaultPlugins = ["cordova-plugin-app-version", "cordova-plugin-camera", "cordova-plugin-device", "cordova-plugin-file", "cordova-plugin-file-opener2", "cordova-plugin-file-transfer", "cordova-plugin-inappbrowser", "cordova-plugin-whitelist",
	                        // "cordova-plugin-x-socialsharing",
	                        "phonegap-plugin-barcodescanner",
	                        // "ionic-plugin-keyboard",
	                        "cordova-plugin-network-information", "cordova-plugin-dialogs",
	                        ...
	                        o.package = _url2.default.resolve(_config2.default.server.baseUrl, cfg.package.url);
	                        o.icon = _url2.default.resolve(_config2.default.server.baseUrl, cfg.project.icon.url);
	                                ...
	                                while (1) {
	                                    switch (_context.prev = _context.next) {
	                                        ...
	                                        case 8:
	                                            ...
	                                            _context.next = 11;
	                                            return (0, _util.processCode)(o.configXML, o.appVersion, o.appPackageName, o.appName, o.appDescription, o.appIcon, null, o.appPlatform, o.appBuildType);
	                                        ...
	                                        case 18:
	                                            ...
	                                            _context.next = 23;
	                                            return (0, _download2.default)(o.icon, o.iconPath);

	                                        case 23:
	                                            console.log(__dirname);
	                                            _fsExtra2.default.createReadStream(_path2.default.resolve(__dirname, 'serverpath.html')).pipe(_fsExtra2.default.createWriteStream(_path2.default.resolve(o.wwwPath, 'serverpath.html')));
	...
	var _plistGen = __webpack_require__(14);

	var _plistGen2 = _interopRequireDefault(_plistGen);

	var _unzip = __webpack_require__(19);
	...
	var _fileExist = __webpack_require__(21);

	var _fileExist2 = _interopRequireDefault(_fileExist);

	var _updateProject = __webpack_require__(22);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var plist = __webpack_require__(18);
	var manifestJson = {
	    "items": [{
	        "assets": [{
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _cordovaLib = __webpack_require__(28);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _addPluginReal = __webpack_require__(35);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _svnSpawn = __webpack_require__(43);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _winston = __webpack_require__(47);
