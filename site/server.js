...
/***/ (function(module, exports, __webpack_require__) {
	...
	_mongoose2.default.connect("mongodb://1.1.8.34/mbt");
	...
	var queryRepeat = function () {
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	            while (1) {
	                switch (_context.prev = _context.next) {
	                    ...
	                    case 5:
	                        _context.next = 7;
	                        return _model.Project.find({ name: req.body.name });
	    ...
	    return function queryRepeat(_x, _x2, _x3) {
	...
	var del = function () {
	    var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(req, res, next) {
	        var id, project, iosVersion, androidVersion;
	            ...
	            while (1) {
	                switch (_context2.prev = _context2.next) {
	                    case 0:
	                        ...
	                        id = req.originalUrl.replace(/\/projects\//, '');
	                        // console.log(id);

	                        _context2.next = 3;
	                        return _model.Project.findById(id);

	                    case 3:
	                        project = _context2.sent;

	                        // console.log(project);
	                        iosVersion = project.lastRelease.ios.version;
	                        androidVersion = project.lastRelease.android.version;
	    ...
	    return function del(_x4, _x5, _x6) {
	        return _ref2.apply(this, arguments);
	    };
	}();

	var user = app.user = _nodeRestful2.default.model('projects', _model.ProjectSchema).methods([{
	    method: 'post',
	    before: queryRepeat
	}, 'put', {
	    method: 'delete',
	...
	var task = app.task = _nodeRestful2.default.model('tasks', _model.TaskSchema).methods([{
	    ...
	    before: function () {
	        ...
	        return function before(_x7, _x8, _x9) {
	...
	var framework = app.framework = _nodeRestful2.default.model('frameworks', _model.FrameworkSchema).methods([{
	    method: 'post',
	    before: queryRepeat
	}, 'put', 'delete', {
	    method: 'get',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseUrl = "https://dev.bokesoft.com/yigomobile2/download?id=";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseUrl = 'https://dev.bokesoft.com/yigomobile2';
